...
<ul class="nav">
    ...
    <li class="has-sub">
        ...
        <ul class="sub-menu">
            <li><a href="http://seantheme.com/color-admin-v2.2/frontend/one-page-parallax/index.html" target="_blank">One Page Parallax</a></li>
            <li><a href="http://seantheme.com/color-admin-v2.2/frontend/blog/index.html" target="_blank">Blog</a></li>
            <li><a href="http://seantheme.com/color-admin-v2.2/frontend/forum/index.html" target="_blank">Forum</a></li>
            <li><a href="http://seantheme.com/color-admin-v2.2/frontend/e-commerce/index.html" target="_blank">E-Commerce</a></li>
        </ul>
    </li>
    <li class="has-sub">
        <a href="javascript:;">
    ...
    <li class="has-sub">
        ...
        <ul class="sub-menu">
            ...
            <li><a href="http://seantheme.com/color-admin-v2.2/admin/material/index.html">MATERIAL DESIGN</a></li>
        </ul>
    </li>
    <li class="has-sub">
        <a href="javascript:;">
